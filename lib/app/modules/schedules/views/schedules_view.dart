                ...
                child: ListView(
                    ...
                    children: <Widget>[
                          ...
                          child: Center(
                            child: Obx(() => Text(
                                  "Escolha o intervalo que deseja ser atendido,\n\nInício: "
                                      ...
                                      "Término: ${controller.end.value.toStringAsFixed(0)}h",
                        ...
                        Obx(() => RangeSlider(
                              ...
                              labels: RangeLabels('${controller.start.value.toStringAsFixed(0)}h', '${controller.end.value.toStringAsFixed(0)}h'),
                              onChanged: (value){
